...
class Listing(db.Model):
    ...
    storefront_email = db.Column(db.String(30), db.ForeignKey(
        'storefront.email'), primary_key=True)
...
class Cart(db.Model):
    ...
    storefront_email = db.Column(db.String(30), db.ForeignKey(
        'storefront.email'), primary_key=True)
    buyer_email = db.Column(db.String(30), db.ForeignKey(
        'buyer.email'), primary_key=True)
...
class Purchase(db.Model):
    ...
    buyer_email = db.Column(db.String(30), db.ForeignKey(
        'buyer.email'), primary_key=True)
    datetime = db.Column(
        db.DateTime, default=datetime.utcnow, primary_key=True)
